...
private const val TRANSFORM_VSHADER = """
...
private const val PASSTHROUGH_FSHADER = """
...
private const val PORTRAIT_FSHADER = """
#extension GL_OES_EGL_image_external : require
precision mediump float;
varying vec2 vTextureCoord;
uniform samplerExternalOES sTexture;
...
class HardwarePipeline(width: Int, height: Int, fps: Int, filterOn: Boolean,
    ...
    private val renderHandler = RenderHandler(renderThread.looper,
    ...
    private class ShaderProgram(
        ...
        fun setVertexAttribArray(vertexCoors: FloatArray) {
            val nativeBuffer = ByteBuffer.allocateDirect(vertexCoors.size * 4)
    ...
    private class RenderHandler(looper: Looper, private val width: Int,
                                private val height: Int, private val fps: Int,
        ...
        private fun createShaderProgram(fragmentShader: Int): ShaderProgram {
            ...
            val vPositionLoc = GLES20.glGetAttribLocation(shaderProgram, "vPosition")
            val texMatrixLoc = GLES20.glGetUniformLocation(shaderProgram, "texMatrix")
